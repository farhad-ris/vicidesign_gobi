...
public class ScratchChecklistColumns {

	private ScratchChecklistColumns() {};


	public static final String TABLENAME = DatabaseHandler.TABLE_SCRATCH_CHECKLIST;
	...
	public static final String CHECKLISTNAME = DatabaseHandler.KEY_CHECKLISTNAME;    


	public static final String FULL_CHECKLISTNAME =  TABLENAME + "." + CHECKLISTNAME;  

	public static final String CHECKLISTID = DatabaseHandler.KEY_CHECKLISTID;

	public static final String FULL_CHECKLISTID = TABLENAME + "." + DatabaseHandler.KEY_CHECKLISTID;
